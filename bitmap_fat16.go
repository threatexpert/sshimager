...
func Fat16ReadBitmap(r io.ReaderAt, partOffset, partSize uint64) (*BlockBitmap, error) {
	...
	// Root directory size in sectors (FAT12/16 only; FAT32 has rootEntCnt=0)
	...
	// Mark reserved + FAT + root dir area as used
	...
	// Walk FAT entries (entries 0,1 are reserved, data starts at entry 2)
...
// FAT12 packs two entries into 3 bytes:
//   even index: low 12 bits of uint16 at byte offset idx*3/2
//   odd index:  high 12 bits of uint16 at byte offset idx*3/2
